...
## Adding Content
To add content to the Data Catalog, you need to add the metadata in the dataset node and add corresponding. Suppose we want to add a dataset with the following information to the Data Catalog. 
