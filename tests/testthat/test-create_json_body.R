...
test_that("title field update works", {
  body <- create_json_body(values = c("title"="Test Create JSON"), node_type = "dataset", root_url = root_url)
  json_template <- list()
...
test_that("text field update works", {
  body = create_json_body(values = c("body"="Test Body"), node_type = "dataset", root_url = root_url)
  json_template <- list()
...
test_that("tid field update works", {
  body = create_json_body(values = c("field_topic"="366"), node_type = "dataset", root_url = root_url)
  json_template <- list()
...
test_that("upi field update works", {
  body = create_json_body(values = c("field_wbddh_dsttl_upi"="46404"), node_type = "dataset", root_url = root_url)
  json_template <- list()
...
test_that("multiple values update works", {
  body = create_json_body(values = c("title"="Test Create JSON", "body"="Test Body",
